...
/*
    ...
    numeros del ususario -> 12,9,6,10,3
...
public class Bonoloto {
    ...
    public void generarNumerosSistema(){ //cuando se llame esta funcion se generaran los numeros del sistema
        for (int i = 0; i< numerosSistema.length; i++){
            numerosSistema[i] = (int) (Math.random()*20+1); //desde el 1 hasta el 20
        }
    }
    ...
    //falta una funcion para comprobar cuantos numeros a tocado y el premio que he tendio
    //hay que hacerlo con for anidado
